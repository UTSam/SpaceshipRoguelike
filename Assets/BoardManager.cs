...
{
    public int boardRows = 20, boardColumns = 20;
    public int minRoomSize = 6, maxRoomSize = 10;
    ...
    public class SubDungeon
    {
        ...
        public bool Split(int minRoomSize, int maxRoomSize)
        {
            ...
            //Check if roomsize can be big enough
    ...
    public void CreateBSP(SubDungeon subDungeon)
    {
        ...
        if (subDungeon.IAmLeaf())
        {
              ...
              || Random.Range(0.0f, 1.0f) > 0.25)
            {
                ...
                {
                    Debug.Log(
                        "Splitted sub-dungeon " + subDungeon.debugId + " in "
